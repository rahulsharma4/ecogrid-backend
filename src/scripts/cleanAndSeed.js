...
const cleanAndSeed = async () => {
  try {
    ...
    const adminUser = new User({
      ...
      email: 'abhishekpandey@ecogridinfra.in',
      phone: '9889555339', // Admin contact
      password: 'Abhi@1994', // Hashes automatically via userModel's pre-save middleware
      role: 'admin',
      status: 'active',
    });
    ...
    console.log('Password: Abhi@1994');
